...
def run_trial(max_ticks: int = 200, lattice_size=(51, 51, 51), scale: int = 2):
    ...
    result_path = os.path.join(os.path.dirname(__file__), "proton_resolution_scan_6_results.json")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--scale", type=int, default=2, help="Proton pattern scale factor")
