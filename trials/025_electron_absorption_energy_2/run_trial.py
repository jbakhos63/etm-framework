...
def run_trial():
    config = ConfigurationFactory.validated_foundation_config("electron_absorption_energy_2")
    config.max_ticks = 1
    ...
    out_path = os.path.join(os.path.dirname(__file__), "electron_absorption_energy_2_results.json")
