...
def run_trial():
    ...
    electric_path = os.path.join(base_dir, "027_electric_force_measurement_3", "electric_force_measurement_3_results.json")
    ...
    out_path = os.path.join(os.path.dirname(__file__), "fine_structure_estimate_3_results.json")
