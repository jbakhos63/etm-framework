...
def run_trial(max_ticks: int = 500, lattice_size=(51, 51, 51)):
    config = ConfigurationFactory.validated_foundation_config("electron_positron_annihilation_3")
    ...
    result_path = os.path.join(os.path.dirname(__file__), "annihilation_3_results.json")
