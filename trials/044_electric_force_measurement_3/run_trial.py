...
def run_trial(max_ticks: int = 500, lattice_size=(51, 51, 51)):
    ...
    for sep in separations:
        config = ConfigurationFactory.validated_foundation_config("electric_force_3")
    ...
    out_path = os.path.join(os.path.dirname(__file__), "electric_force_measurement_3_results.json")
