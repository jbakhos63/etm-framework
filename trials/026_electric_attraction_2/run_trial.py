...
def run_trial(max_ticks: int = 500, lattice_size=(51, 51, 51)):
    config = ConfigurationFactory.validated_foundation_config("electric_attraction_2")
    ...
    out_path = os.path.join(os.path.dirname(__file__), "electric_attraction_2_results.json")
