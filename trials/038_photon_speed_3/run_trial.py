...
def run_trial(max_ticks: int = 500, lattice_size=(51, 51, 51)):
    config = ConfigurationFactory.validated_foundation_config("photon_speed_3")
    ...
    out_path = os.path.join(os.path.dirname(__file__), "photon_speed_3_results.json")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Extended photon speed trial")
