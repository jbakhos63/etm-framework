...
def run_trial(max_ticks: int = 200, lattice_size=(51, 51, 51), scale: int = 3):
    ...
    result_path = os.path.join(os.path.dirname(__file__), "proton_resolution_scan_7_results.json")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--scale", type=int, default=3, help="Proton pattern scale factor")
