...
def run_trial():
    config = ConfigurationFactory.validated_foundation_config("electron_absorption_energy")
    config.max_ticks = 1
    ...
    out_path = os.path.join(os.path.dirname(__file__), "absorption_energy_results.json")
