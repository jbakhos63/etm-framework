...
def run_trial():
    config = ConfigurationFactory.validated_foundation_config("planck_interval_3")
    ...
    out_path = os.path.join(os.path.dirname(__file__), "planck_interval_3_results.json")
